...
import {AddLoanProductComponent} from '../../../../configs/manage-loan-products/add-loan-product/add-loan-product.component';
...
export class LoanCyclesBankComponent implements OnInit {
    ...
    public openModal(parentData: any) {
        this.modalRef = this.modalService.open(OpenConfirmPaymentDialogComponent);
        this.modalRef.componentInstance.title = 'Confirm Cycle Payment';
