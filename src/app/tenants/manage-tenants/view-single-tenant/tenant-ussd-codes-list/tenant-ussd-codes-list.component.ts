...
@Component({
  selector: 'app-tenant-ussd-codes-list',
  templateUrl: './tenant-ussd-codes-list.component.html',
  styleUrls: ['./tenant-ussd-codes-list.component.scss'],
  providers: [DatePipe]
})
export class TenantUssdCodesListComponent implements OnInit {
  @Input() parentData;
  public formData;
  ...
  public openModal(formData) {
    this.formData = formData;
     this.modalRef = this.modalService.open(TenantUssdCodeAddComponent);
    if (formData) {
      this.modalRef.componentInstance.title = 'Edit USSD CODE ';
    } else {
      this.modalRef.componentInstance.title = 'Add USSD CODE';
    }
