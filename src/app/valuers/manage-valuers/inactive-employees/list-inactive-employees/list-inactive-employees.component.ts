...
@Component({
    selector: 'app-list-inactive-employees',
    templateUrl: './list-inactive-employees.component.html',
    styleUrls: ['./list-inactive-employees.component.scss'],
    providers: [DatePipe]
})
export class ListInactiveEmployeesComponent implements OnInit {
    ...
    private viewCompany(data: any): void {
        ...
        console.log(data);
        this.router.navigate(['employees', 'inactive', data.id], {skipLocationChange: true});
    }
