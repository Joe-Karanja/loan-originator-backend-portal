...
@Component({
  selector: 'app-list-claims-under-inspection',
  templateUrl: './list-claims-under-inspection.component.html',
  styleUrls: ['./list-claims-under-inspection.component.scss'],
  providers: [DatePipe]
})
export class ListClaimsUnderInspectionComponent implements OnInit {
    public formData;
    ...
    private viewRecord(data: any) {
      this.router.navigate(['motor/inspection', data.client_claim_id]);
    }
}
