...
@Component({
  selector: 'app-list-settled-claims',
  templateUrl: './list-settled-claims.component.html',
  styleUrls: ['./list-settled-claims.component.scss'],
  providers: [DatePipe]
})
export class ListSettledClaimsComponent implements OnInit {
