...
@Component({
  selector: 'app-completed-valuations',
  templateUrl: './completed-valuations.component.html',
  styleUrls: ['./completed-valuations.component.scss'],
  providers: [DatePipe]
})
export class CompletedValuationsComponent implements OnInit {
  public formData;
  ...
  private loadData(): any {
    ...
    this._httpService.post('', model).subscribe(
      result => {
        this.dataSet = result.list.valuation_completed;
      },
      error => {
      },
      complete => {
