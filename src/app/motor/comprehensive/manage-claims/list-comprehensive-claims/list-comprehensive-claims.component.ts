...
@Component({
  selector: 'app-list-comprehensive-claims',
  templateUrl: './list-comprehensive-claims.component.html',
  styleUrls: ['./list-comprehensive-claims.component.scss'],
  providers: [DatePipe, CurrencyPipe]
})
export class ListComprehensiveClaimsComponent implements OnInit {
