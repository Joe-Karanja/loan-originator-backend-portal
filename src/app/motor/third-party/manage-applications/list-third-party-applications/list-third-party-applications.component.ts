...
@Component({
  selector: 'app-list-third-party-applications',
  templateUrl: './list-third-party-applications.component.html',
  styleUrls: ['./list-third-party-applications.component.scss'],
  providers: [DatePipe, CurrencyPipe]
})
export class ListThirdPartyApplicationsComponent implements OnInit {
