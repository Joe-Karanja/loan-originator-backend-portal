...
export class CorporatesComponent implements OnInit {
  ...
  public settings = {
    ...
    delete: {
      deleteButtonContent: '&nbsp;&nbsp;<i class="fa fa-trash-o text-danger text-center mr-2"></i><span class="text-danger">Disable</span> &nbsp;&nbsp;&nbsp;',
      confirmDelete: true
    },
  ...
  public openModal(parentData: any) {
    ...
    this.modalRef.componentInstance.title = 'Add New Corporate';
